...
Model = collections.namedtuple("Model",
                               "outputs, predict_real, predict_fake, global_discrim_loss,local_discrim_loss, discrim_grads_and_vars, gen_loss_GAN, gen_loss_L1, gen_grads_and_vars, train")
...
def create_model(inputs, condition1, condition2, targets):
    ...
    update_losses = ema.apply([global_discrim_loss,local_discrim_loss, gen_loss_GAN, gen_loss_L1])
