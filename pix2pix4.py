...
def create_generator(generator_inputs, discrimCon1, discrimCon2, generator_outputs_channels):
    ...
    with tf.variable_scope("encoder_1"):
        output = conv(generatorInputs, a.ngf, stride=2)
...
def main():
    ...
    # 训练的时候的参数(由于采用
    # a.input_dir = "E:\data\train\image4LefRig"
    # a.mode = "train"
    # a.output_dir = "E:\ckt\image4LefRig"
    # a.max_epochs=300
    # a.which_direction = "BtoA"
    a.input_dir = "C:/TensorFlow/Pix2Pix/train"
    a.mode = "train"
    a.output_dir = "C:/TensorFlow/Pix2Pix/Checkpoint"
    a.max_epochs=300
    a.which_direction = "BtoA"

    # 测试的时候的参数
    #a.input_dir = "/home/yuanfly/pix2pix/facades/restoreVal/1_images"
    #a.mode = "test"
    #a.output_dir = "/home/yuanfly/pix2pix/facades/restoreTest/1_images"
    #a.checkpoint = "/home/yuanfly/pix2pix/facades/cktRestore/1_images"
